...
@router.get("/doctor/{doctor_id}", status_code=status.HTTP_201_CREATED, response_model=appointmentSchema.AppointmentResponseDTO)
...
@router.get("/patient/{patient_id}", status_code=status.HTTP_201_CREATED, response_model=appointmentSchema.AppointmentResponseDTO)
